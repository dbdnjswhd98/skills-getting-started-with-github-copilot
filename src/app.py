...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice teamwork, fitness, and match play through soccer",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Team": {
        "description": "Train endurance and technique in competitive swimming",
        "schedule": "Mondays, Wednesdays, Fridays, 6:30 AM - 7:30 AM",
        "max_participants": 16,
    ...
    "Robotics Club": {
        "description": "Build and program robots while exploring engineering concepts",
